...
class KlotskiLevel {
  ...
  static final List<KlotskiLevel> levels = [
    // Public layouts from jeantimex/klotski; mirrored public layouts fill
    // the numbered set so players get 50 non-random boards.
    KlotskiLevel(
      id: 'level_1',
      name: '1',
      description: '横刀立马 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 0, 0),
    ...
    KlotskiLevel(
      id: 'level_2',
      name: '2',
      description: '指挥若定 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 0, 0),
    ...
    KlotskiLevel(
      id: 'level_3',
      name: '3',
      description: '将拥曹营 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 4, 0),
        _v('zhang', 1, 0),
    ...
    KlotskiLevel(
      id: 'level_4',
      name: '4',
      description: '齐头并进 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 3, 1),
        _v('zhang', 0, 0),
    ...
    KlotskiLevel(
      id: 'level_5',
      name: '5',
      description: '并分三路 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 1, 0),
    ...
    KlotskiLevel(
      id: 'level_6',
      name: '6',
      description: '雨声淅沥 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 0, 0),
    ...
    KlotskiLevel(
      id: 'level_7',
      name: '7',
      description: '左右布兵 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 4, 1),
        _v('zhang', 2, 0),
    ...
    KlotskiLevel(
      id: 'level_8',
      name: '8',
      description: '桃花园中 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 4, 1),
        _v('zhang', 1, 0),
    ...
    KlotskiLevel(
      id: 'level_9',
      name: '9',
      description: '一路进军 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 4, 1),
        _v('zhang', 0, 0),
    ...
    KlotskiLevel(
      id: 'level_10',
      name: '10',
      description: '一路顺风 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 0, 0),
    ...
    KlotskiLevel(
      id: 'level_11',
      name: '11',
      description: '围而不歼 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 0, 0),
    ...
    KlotskiLevel(
      id: 'level_12',
      name: '12',
      description: '捷足先登 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 3, 0),
    ...
    KlotskiLevel(
      id: 'level_13',
      name: '13',
      description: '插翅难飞 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 0),
        _h('zhang', 3, 1),
    ...
    KlotskiLevel(
      id: 'level_14',
      name: '14',
      description: '守口如瓶 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 4, 0),
        _h('zhang', 4, 2),
    ...
    KlotskiLevel(
      id: 'level_16',
      name: '16',
      description: '双将挡路 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _h('zhang', 3, 1),
    ...
    KlotskiLevel(
      id: 'level_17',
      name: '17',
      description: '横马当关 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 0),
        _h('zhang', 2, 2),
    ...
    KlotskiLevel(
      id: 'level_18',
      name: '18',
      description: '层层设防 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _h('zhang', 3, 1),
    ...
    KlotskiLevel(
      id: 'level_20',
      name: '20',
      description: '兵挡将阻 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _h('zhang', 3, 1),
    ...
    KlotskiLevel(
      id: 'level_21',
      name: '21',
      description: '堵塞要道 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 2),
        _h('zhang', 3, 2),
    ...
    KlotskiLevel(
      id: 'level_22',
      name: '22',
      description: '瓮中之鳖 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 0),
        _h('zhang', 2, 2),
    ...
    KlotskiLevel(
      id: 'level_23',
      name: '23',
      description: '层峦叠嶂 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _h('zhang', 3, 0),
    ...
    KlotskiLevel(
      id: 'level_24',
      name: '24',
      description: '水泄不通 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 0),
        _h('zhang', 2, 2),
    ...
    KlotskiLevel(
      id: 'level_25',
      name: '25',
      description: '四路进兵 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 2),
        _h('zhang', 3, 2),
    ...
    KlotskiLevel(
      id: 'level_26',
      name: '26',
      description: '入地无门 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _h('zhang', 3, 0),
    ...
    KlotskiLevel(
      id: 'level_27',
      name: '27',
      description: '勇闯五关 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 0),
        _h('zhang', 2, 2),
    ...
    KlotskiLevel(
      id: 'level_28',
      name: '28',
      description: '四面楚歌 - jeantimex/klotski',
      pieces: [
        _cao(1, 1),
        _h('guan', 3, 1),
        _v('zhang', 0, 0),
    ...
    KlotskiLevel(
      id: 'level_29',
      name: '29',
      description: '前呼后拥 - jeantimex/klotski',
      pieces: [
        _cao(0, 2),
        _h('guan', 1, 0),
        _h('zhang', 2, 0),
    ...
    KlotskiLevel(
      id: 'level_30',
      name: '30',
      description: '兵临曹营 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 2, 0),
    ...
    KlotskiLevel(
      id: 'level_31',
      name: '31',
      description: '五将逼宫 - jeantimex/klotski',
      pieces: [
        _cao(1, 1),
        _h('guan', 0, 0),
        _h('zhang', 0, 2),
    ...
    KlotskiLevel(
      id: 'level_32',
      name: '32',
      description: '前挡后阻 - jeantimex/klotski',
      pieces: [
        _cao(0, 0),
        _h('guan', 0, 2),
        _h('zhang', 4, 1),
    ...
    KlotskiLevel(
      id: 'level_33',
      name: '33',
      description: '近在咫尺 - jeantimex/klotski',
      pieces: [
        _cao(3, 2),
        _h('guan', 2, 0),
        _h('zhang', 3, 0),
    ...
    KlotskiLevel(
      id: 'level_34',
      name: '34',
      description: '走投无路 - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _v('guan', 0, 0),
        _v('zhang', 0, 3),
    ...
    KlotskiLevel(
      id: 'level_35',
      name: '35',
      description: '比翼横空 - jeantimex/klotski',
      pieces: [
        _cao(0, 2),
        _h('guan', 0, 0),
        _h('zhang', 1, 0),
    ...
    KlotskiLevel(
      id: 'level_36',
      name: '36',
      description: '夹道藏兵 - jeantimex/klotski',
      pieces: [
        _cao(0, 0),
        _h('guan', 2, 0),
        _h('zhang', 2, 2),
    ...
    KlotskiLevel(
      id: 'level_37',
      name: '37',
      description: '屯兵东路 - jeantimex/klotski',
      pieces: [
        _cao(0, 0),
        _h('guan', 2, 0),
        _v('zhang', 0, 2),
    ...
    KlotskiLevel(
      id: 'level_38',
      name: '38',
      description: '四将连关 - jeantimex/klotski',
      pieces: [
        _cao(0, 0),
        _h('guan', 0, 2),
        _h('zhang', 1, 2),
    ...
    KlotskiLevel(
      id: 'level_39',
      name: '39',
      description: '峰回路转 - jeantimex/klotski',
      pieces: [
        _cao(1, 0),
        _h('guan', 3, 1),
        _h('zhang', 4, 2),
    ...
    KlotskiLevel(
      id: 'level_40',
      name: '40',
      description: '将拥曹营 (mirror) - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 4, 2),
        _v('zhang', 1, 0),
    ...
    KlotskiLevel(
      id: 'level_41',
      name: '41',
      description: '雨声淅沥 (mirror) - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 0, 3),
    ...
    KlotskiLevel(
      id: 'level_42',
      name: '42',
      description: '一路进军 (mirror) - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 4, 1),
        _v('zhang', 0, 3),
    ...
    KlotskiLevel(
      id: 'level_43',
      name: '43',
      description: '一路顺风 (mirror) - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 0, 3),
    ...
    KlotskiLevel(
      id: 'level_44',
      name: '44',
      description: '围而不歼 (mirror) - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _v('zhang', 0, 3),
    ...
    KlotskiLevel(
      id: 'level_45',
      name: '45',
      description: '插翅难飞 (mirror) - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 2),
        _h('zhang', 3, 1),
    ...
    KlotskiLevel(
      id: 'level_46',
      name: '46',
      description: '守口如瓶 (mirror) - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 4, 0),
        _h('zhang', 4, 2),
    ...
    KlotskiLevel(
      id: 'level_48',
      name: '48',
      description: '双将挡路 (mirror) - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _h('zhang', 3, 1),
    ...
    KlotskiLevel(
      id: 'level_49',
      name: '49',
      description: '横马当关 (mirror) - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 0),
        _h('zhang', 2, 2),
    ...
    KlotskiLevel(
      id: 'level_50',
      name: '50',
      description: '兵挡将阻 (mirror) - jeantimex/klotski',
      pieces: [
        _cao(0, 1),
        _h('guan', 2, 1),
        _h('zhang', 3, 1),
